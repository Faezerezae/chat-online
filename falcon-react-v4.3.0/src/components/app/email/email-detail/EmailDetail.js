            ...
            <Card>
                <Card.Header>
                    <Row>
                        <Col md as={Flex}>
                            <Avatar
                                src={emailDetails.sender.avatarSrc}
                                size="2xl"
                            />
                        ...
                        <Col lg={8} xxl={6}>
                            <Card className="shadow-none mb-3">
                                ...
                                <Card.Body>
                                    ...
                                    <p>
                                        On International Women’s Day, we at
                                        ThemeWagon want you to discover the
                                        skills you can learn from our amazing
                                        women digital marketing instructors.
                                    </p>
                                    <p>
                                        That's not all, when you enroll in one
                                        of their courses, use promo code:
                                        <code> GirlPower20 </code>and get
                                        <a href="#!" className="fw-semi-bold">
                                            {' '}
                                            20% off{' '}
                                        </a>
                                        as our Women's Day gift to you. This
                                        offer{' '}
                                        <a href="#!" className="fw-semi-bold">
                                            expires in 7 days
                                        </a>{' '}
                                    ...
                                    <div className="text-center">
                                        ...
                                        <small className="d-block">
                                            For any technical issues faced,
                                            please contact{' '}
                            ...
                            <div className="text-center">
                                ...
                                />
                                <small>
                                    If you wish to unsubscribe from all future
                                    emails, please <a href="#!">click here</a>
                                </small>
                            </div>
                        </Col>
                    </Row>
