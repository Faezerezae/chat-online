                        ...
                        render={({ field, ref }) => (
                            <MultiSelect
                                ...
                                options={[
                                    {
                                        value: '1',
                                        label: 'Total 13 hours of video lectures'
                                    },
                                    {
                                        value: '2',
                                        label: '12 premium article access'
                                    },
                                    {
                                        value: '3',
                                        label: '11 downloadable resources'
                                    },
                                    {
                                        value: '4',
                                        label: 'Mobile, Tab or TV friendly content'
                                    }
                                ]}
