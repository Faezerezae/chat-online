            ...
            <Card.Body className="position-relative">
                <Row>
                    <Col xl={10}>
                        ...
                        <p className="mb-0">
                            Enlighten the world with your knowledge. Use our
                            Course Creator to design a well-structured course;
                            set whatever price you feel worthy of, and publish
                            at our platform.
                            <br />
                            or,
                            <br className="d-lg-none" />
                            Want to edit your existing course? Jump to
                            <Link to="/e-learning/course/course-grid">
                                {' '}
                                Your courses
                            </Link>
                        </p>
