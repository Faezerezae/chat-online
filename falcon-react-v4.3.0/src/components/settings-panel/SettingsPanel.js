            ...
            <Offcanvas.Body className="scrollbar">
                ...
                <Flex justifyContent="between">
                    ...
                    <Form.Check
                        ...
                        checked={isRTL}
                        onChange={({ target }) =>
                            setConfig('isRTL', target.checked)
                        }
                    />
                </Flex>
                <hr />
                ...
                <Flex justifyContent="between">
                    ...
                    <Form.Check
                        ...
                        checked={isFluid}
                        onChange={({ target }) =>
                            setConfig('isFluid', target.checked)
                        }
                    />
                </Flex>
                <hr />
                ...
                <Flex>
                    ...
                    <div>
                        ...
                        >
                            {['vertical', 'top', 'combo', 'double-top'].map(
                                option => (
                                    <option
                                        key={option}
                                        disabled={disabledNavbarPosition.includes(
                                            option
                                        )}
                                        value={option}
                                    >
                ...
                <div className="text-center mt-5">
                    ...
                    <p className="fs--1">
                        Get Falcon now and create beautiful dashboards with
                        hundreds of widgets.
                    </p>
                    <Button
                        color="primary"
