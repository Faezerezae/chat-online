...
import Chats from 'components/app/chat/chats/Chats';
import WidgetSettings from 'components/app/chat/setting/content/WidgetSettings';
import ReadyAnswer from 'components/app/chat/setting/content/ReadyAnswer';
...
import MainLayoutSettingChat from 'components/app/chat/setting/MainLayoutSettingChat';
import WarningNotification from 'components/app/chat/setting/content/WarningNotification';
import OfflineStatus from 'components/app/chat/setting/content/OfflineStatus';
import HoursOfWork from 'components/app/chat/setting/content/HoursOfWork';
import BeforeStartingTheConversation from 'components/app/chat/setting/content/BeforeStartingTheConversation';
import DelayInResponse from 'components/app/chat/setting/content/DelayInResponse';
import QuestionsAndAnswers from 'components/app/chat/setting/content/QuestionsAndAnswers';
import RatingTheOperator from 'components/app/chat/setting/content/RatingTheOperator';
import TextBeingTypedByTheRecipient from 'components/app/chat/setting/content/TextBeingTypedByTheRecipient';
import ActivePages from 'components/app/chat/setting/content/ActivePages';
import AssignOperatorToPage from 'components/app/chat/setting/content/AssignOperatorToPage';
import CommunicationWithAPI from 'components/app/chat/setting/content/CommunicationWithAPI';
import ConnectToTelegram from 'components/app/chat/setting/content/ConnectToTelegram';
import InActivePages from 'components/app/chat/setting/content/InActivePages';
        ...
        <Routes>
            ...
            <Route element={<MainLayout />}>
                ...
                <Route
                    path="chat/chats"
                    element={
                        <PrivateRoute user={user} expectedRole="support">
                            <Chats />
                        </PrivateRoute>
                    }
                />
                <Route element={<MainLayoutSettingChat />}>
                    <Route path="chat/setting/" element={<WidgetSettings />} />
                    <Route
                        path="chat/setting/ready-answer"
                        element={<ReadyAnswer />}
                    />
                    <Route
                        path="chat/setting/warning-notification"
                        element={<WarningNotification />}
                    />
                    <Route
                        path="chat/setting/offline-status"
                        element={<OfflineStatus />}
                    />
                    <Route
                        path="chat/setting/Hours-of-work"
                        element={<HoursOfWork />}
                    />
                    <Route
                        path="chat/setting/before-starting-the-conversation"
                        element={<BeforeStartingTheConversation />}
                    />
                    <Route
                        path="chat/setting/delay-in-response"
                        element={<DelayInResponse />}
                    />
                    <Route
                        path="chat/setting/questions-and-answers"
                        element={<QuestionsAndAnswers />}
                    />
                    <Route
                        path="chat/setting/rating-the-operator"
                        element={<RatingTheOperator />}
                    />
                    <Route
                        path="chat/setting/text-being-typed-by-the-recipient"
                        element={<TextBeingTypedByTheRecipient />}
                    />
                    <Route
                        path="chat/setting/inactive-pages"
                        element={<InActivePages />}
                    />
                    <Route
                        path="chat/setting/active-pages"
                        element={<ActivePages />}
                    />
                    <Route
                        path="chat/setting/assign-operator-to-page"
                        element={<AssignOperatorToPage />}
                    />
                    <Route
                        path="chat/setting/communication-with-API"
                        element={<CommunicationWithAPI />}
                    />
                    <Route
                        path="chat/setting/connect-to-Telegram"
                        element={<ConnectToTelegram />}
                    />
                </Route>
                {/* support desk */}
                <Route
...
const PrivateRoute = ({ children, user, expectedRole }) => {
    return user && user.role === expectedRole ? (
        children
    ) : (
        <Navigate to="/authentication/simple/login" />
    );
};
